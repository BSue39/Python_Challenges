...
# Load the dataset
dataset = pd.read_csv(r'C:\Users\bfens\OneDrive\Documents\GitHub\Python_Challenges\dataset_1.csv')
...
# Caluculate descriptive statistics for each column in the dataset
summary_stats = dataset.describe()
print("Descriptive Statistics:")
print(summary_stats)

# Perform porbability calculation
if len(dataset) >= 8:
