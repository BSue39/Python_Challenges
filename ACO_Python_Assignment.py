# Import numpy and give it a shorthand alias
import numpy  as np
    ...
    for iteration in range(num_iterations):
        ...
        for ant in range(num_ants):
            ...
            for _ in range(num_cities - 1):
                ...
                selection_probs[np.array(visited)] = 0 # Set selection probablities of visited cities to 0

                # Choose the next city based on the selection probablities
...
# Run the Ant Colony Optimization algorithn
num_iterations = 225 # Number of iterations
